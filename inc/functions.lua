...
download_file('https://raw.githubusercontent.com/iamabazawhourhhhhhh/ggg/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @xb_0b     |') end
download_file('https://raw.githubusercontent.com/iamabazawhourhhhhhh/ggg/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @r00t94   |') end
download_file('https://raw.githubusercontent.com/iamabazawhourhhhhhh/ggg/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @xb_0b  |') end
download_file('https://raw.githubusercontent.com/iamabazawhourhhhhhh/ggg/main/inc/functions.lua','./inc/functions.lua')
