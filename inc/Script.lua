...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/iamabazawhourhhhhhh/gare77.github.io/main/GetVersion.txt') or "0"
...
if MsgText[1] == "اغنيه"  then
local text = " [مطور السورس](t.me/a_l_q_a_lb_a_l_j_a_r_i_h)"
local audio = "https://t.me/meeeeyty/274"
return sendAudio(msg.chat_id_,text,audio,msg.id_)
end
